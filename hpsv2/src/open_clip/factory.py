...
# A dictionary that stores the loaded model configurations, indexed by model name, so the system can access the configuration of any model by name.
...
def create_model_and_transforms(
    ...
    if with_score_predictor:  # If is True, a Multi-Layer Perceptron (MLP) is added to the model as a score predictor. The size of this predictor is based on the model’s visual projection size.
